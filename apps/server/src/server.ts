...
import * as SettledWorktreeCleanup from "./orchestration/SettledWorktreeCleanup.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(SettledWorktreeCleanup.layer),
...
const MultiworkLayerLive = MultiworkService.layer.pipe(Layer.provideMerge(GitVcsDriver.layer));
...
const RuntimeCoreDependenciesLive = ReactorLayerLive.pipe(
  ...
  Layer.provideMerge(Layer.mergeAll(ServerEnvironmentLayerLive, AuthLayerLive)),
