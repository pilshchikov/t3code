...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.projectsWatchEntries]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.gitHistory]: AuthOrchestrationReadScope,
  [WS_METHODS.gitCommitDetails]: AuthOrchestrationReadScope,
  [WS_METHODS.gitCommitDiff]: AuthOrchestrationReadScope,
  [WS_METHODS.multiworkCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.multiworkList]: AuthOrchestrationReadScope,
  [WS_METHODS.projectMemoryList]: AuthOrchestrationReadScope,
  [WS_METHODS.projectMemoryRead]: AuthOrchestrationReadScope,
  [WS_METHODS.projectMemorySave]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectMemoryRemove]: AuthOrchestrationOperateScope,
