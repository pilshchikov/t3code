...
import type { EnvironmentMachineKind, ScopedThreadRef, ThreadId } from "@t3tools/contracts";
...
export default function Sidebar() {
  ...
  const sidebarListItems = useMemo((): readonly SidebarListItem[] => {
    ...
    const activeRows = rowsOf(orderedActiveThreads, "active");
  ...
  const dndCollisionDetection = useMemo(() => {
    ...
    return createSidebarCollisionDetection(
      (id) => {
        ...
        if (draggedFromSection === "active" && target.section === "active") return true;
        return (
          planSidebarThreadDrop({
              ...
              projectScope={
                <Combobox
                  ...
                  onItemHighlighted={(item) => {
                    ...
                    hoveredProjectScopeKeyRef.current =
                      ...
                      {(item: (typeof projectScopeItems)[number]) => {
                        ...
                        return (
                          <ComboboxItem
                            ...
                            onMouseEnter={() => {
                              hoveredProjectScopeKeyRef.current = project?.projectKey ?? null;
                            }}
                            onMouseLeave={() => {
                              hoveredProjectScopeKeyRef.current = null;
                            }}
                          ...
                          >
                            ...
                            {slot === null ? null : (
                              <Kbd className="ms-auto shrink-0">
                      ...
                      const renderThreadRow = (
                        ...
                        return (
                          <SortableThreadRow
                            ...
                            id={threadKey}
                            disabled={
                              (section !== "active" && !draggableThreadKeys.has(threadKey)) ||
                              optimisticDrop !== null
                            }
                          >
                            {(bag) =>
...
import { buildBulkUnpinContextMenuItem } from "./Sidebar.logic";
