        ...
        >
          <PlainTextPlugin
            contentEditable={
              <ContentEditable
                className={cn(
                  "block max-h-50 min-h-[1lh] w-full overflow-y-auto whitespace-pre-wrap wrap-break-word bg-transparent leading-relaxed text-foreground focus:outline-none",
                  className,
                )}
                data-testid="composer-editor"
                aria-placeholder={
                  typeof placeholder === "string" ? placeholder : "Message composer"
                }
                placeholder={<span />}
                onKeyDown={(event) => {
                  if (
