...
export const COMPOSER_CONTEXT_STRIP_COLLAPSED_BY_PROJECT_KEY =
  "t3code:composer-context-strip-collapsed-by-project";
export const MAX_HIDDEN_MOUNTED_TERMINAL_THREADS = 10;

export const ENVIRONMENT_RECONNECT_WARNING_GRACE_MS = 2_000;

export const LastInvokedScriptByProjectSchema = Schema.Record(ProjectId, Schema.String);
export const ComposerContextStripCollapsedByProjectSchema = Schema.Record(
  ProjectId,
  Schema.Boolean,
);
...
export function resolveDraftPromotionNavigationTarget(input: {
  ...
  serverThread?: Pick<Thread, "latestTurn" | "session" | "messages"> | null;
  ...
  if (input.serverThreadStarted !== undefined) {
