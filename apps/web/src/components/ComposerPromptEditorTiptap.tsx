...
function ComposerPromptEditorTiptapInner(props: ComposerPromptEditorProps) {
  ...
  const editorAttributes = useMemo(
    () => ({
      class: cn(
        "composer-tiptap -m-1 block max-h-52 min-h-[1lh] overflow-y-auto p-1 whitespace-pre-wrap wrap-break-word bg-transparent leading-relaxed text-foreground focus:outline-none",
        className,
      ),
