...
describe("thread navigation helpers", () => {
  ...
  it("reserves default number keys for project slots on desktop, not browser tabs", () => {
...
describe("model picker navigation helpers", () => {
  ...
  it("uses model jumps in the desktop picker and project slots elsewhere", () => {
...
describe("resolveShortcutCommand", () => {
  ...
  it("navigates editor history with mod+[ and mod+] outside the terminal", () => {
