...
export const ThreadEnvMode = Schema.Literals(["local", "worktree", "multiwork"]);
...
export const ServerSettings = Schema.Struct({
  ...
  // Base directory for isolated "multiwork" repo copies. Empty resolves to ~/workplace/git/multiwork.
