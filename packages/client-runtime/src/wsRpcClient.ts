...
export interface WsRpcClient {
  ...
  readonly projects: {
    ...
    readonly searchCode: RpcUnaryMethod<typeof WS_METHODS.projectsSearchCode>;
  ...
  readonly multiwork: {
    readonly create: RpcUnaryMethod<typeof WS_METHODS.multiworkCreate>;
    readonly list: RpcUnaryNoArgMethod<typeof WS_METHODS.multiworkList>;
  };
  readonly server: {
...
export function createWsRpcClient(
  ...
  return {
    ...
    projects: {
      ...
      searchCode: (input) =>
        transport.request((client) => client[WS_METHODS.projectsSearchCode](input)),
      writeFile: (input) =>
    ...
    multiwork: {
      create: (input) => transport.request((client) => client[WS_METHODS.multiworkCreate](input)),
      list: () => transport.request((client) => client[WS_METHODS.multiworkList]({})),
    },
    server: {
